...
Route::group(['prefix'	=>	'/api'],function(){
	...
	Route::group(['prefix'	=>	'/user'], function(){
        ...
        Route::post('/unbind','UserController@unbindPhone');
	...
	Route::group(['prefix'	=>	'/pay'], function(){
		...
		Route::get('/h5','PayController@payHtml');
		...
		Route::get('/fail', 'PayController@failHtml');
		Route::get('/false', 'PayController@failHtml');
		Route::get('/undefined', 'PayController@failHtml');
	});
});
